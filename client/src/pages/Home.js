  ...
  const getAllTransactions = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(
        "https://smart-saver-gqrd.onrender.com/api/v1/transaction/get-all-transaction",
        params
      );
  ...
  const handleDelete = async (transactionId) => {
    try {
      const { data } = await axios.delete(
        `https://smart-saver-gqrd.onrender.com/api/v1/transaction/delete-transaction/${transactionId}`
      );
      if (data.success) {
      ...
      console.log(error);
      toast.error("Error in deleting transactions");
    }
  };
  ...
  return (
    <Layout>
      ...
      {loading ? (
        ...
        // Render table view if transactions available
        ...
        // Render graph view if transactions available
        <div>
